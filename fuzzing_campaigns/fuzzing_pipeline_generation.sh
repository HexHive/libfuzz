...
export CONF=grammar; ./select_stable_drivers_cluster.py -d ${GEN24_DEEP0} -t 3h -k
export CONF=grammar; ./run_dynamic_drv_deep.py; ./run_coverage.sh
export CONF=grammar; ./cp_coverage_from_generation_phase.py -d ${GEN24_DEEP0} -t 3h
...
export CONF=grammar; ./select_stable_drivers_cluster.py -d ${GEN24_DEEP0} -t 2h -k
export CONF=grammar; ./run_dynamic_drv_deep.py; ./run_coverage.sh
export CONF=grammar; ./cp_coverage_from_generation_phase.py -d ${GEN24_DEEP0} -t 2h
export CONF=grammar; ./run_coverage.sh recalciter; ./get_total_library_coverage.sh; 
store_results_to ${GEN12_DEEP12}

# select best drivers from 6h and deep for 18h
export CONF=grammar; ./select_stable_drivers_cluster.py -d ${GEN24_DEEP0} -t 1h -k
export CONF=grammar; ./run_dynamic_drv_deep.py; ./run_coverage.sh
export CONF=grammar; ./cp_coverage_from_generation_phase.py -d ${GEN24_DEEP0} -t 1h
export CONF=grammar; ./run_coverage.sh recalciter; ./get_total_library_coverage.sh; 
