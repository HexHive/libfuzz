...
# dot -Tpdf svfir_iniial.dot -o vfir_initial.dot.pdf
# dot -Tpdf svfg_final.dot -o svfg_final.dot.pdf
dot -Tpdf icfg_extractor.dot -o icfg_extractor.dot.pdf
dot -Tpdf cg_extractor.dot -o cg_extractor.dot.pdf
dot -Tpdf svfg_extractor.dot -o svfg_extractor.dot.pdf