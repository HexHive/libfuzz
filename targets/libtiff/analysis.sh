...
$LIBFUZZ/condition_extractor/bin/extractor -interface $LIBFUZZ/targets/libtiff/interface.json $WORK/lib/libtiff.a.bc -output $LIBFUZZ_LOG_PATH/conditions.json -v v1 -t json
