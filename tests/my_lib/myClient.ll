; ModuleID = 'myClient.cpp'
source_filename = "myClient.cpp"
...
define dso_local i32 @main() #0 !dbg !7 {
  ...
  call void @print_value(i32 10), !dbg !11
  ret i32 0, !dbg !12
}

declare dso_local void @print_value(i32) #1
...
!1 = !DIFile(filename: "myClient.cpp", directory: "/workspace/libfuzz/tests/my_lib")
!2 = !{}
...
!12 = !DILocation(line: 7, column: 5, scope: !7)
