...
define dso_local void @print_value(i32 %x) #4 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, i32* %x.addr, align 4
  %0 = load i32, i32* %x.addr, align 4
  %call = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) @_ZSt4cout, i32 %0)
  %call1 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  ret void
}
...
define dso_local void @_Z9set_statei(i32 %x) #5 {
entry:
  %x.addr = alloca i32, align 4
  store i32 %x, i32* %x.addr, align 4
  %0 = load i32, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local i32 @_Z9get_statev() #5 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local void @leak() #5 {
entry:
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local i32 @taint() #5 {
entry:
  ret i32 10
}

; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local void @startservice() #5 {
entry:
  %x = alloca i32, align 4
  %call = call i32 @_Z9get_statev()
...
if.end:                                           ; preds = %entry
  call void @_Z9set_statei(i32 1)
  %call1 = call i32 @taint()
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local void @stopservice() #5 {
entry:
  %call = call i32 @_Z9get_statev()
  %cmp = icmp eq i32 %call, 1
  br i1 %cmp, label %if.then, label %if.end
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local i32 @getservicestate() #5 {
entry:
  %call = call i32 @_Z9get_statev()
  ret i32 %call
}
...
!1 = !{!"clang version 12.0.0 (git@github.com:HexHive/libfuzz.git a98580cc708f9c294b167facb1fb83065630a866)"}
