...
def _main():
    ...
    # print("library,line_trv_avg,line_tot,line_per,branch_trv_avg,branch_tot,branch_per")
    print("library,line_trv_avg,line_per,branch_trv_avg,branch_per")
    ...
    for p in projects:
        ...
        s = f"{p},{line_trv:.2f} ({lines_per:.2%}),{branch_trv:.2f} ({branch_per:.2%})"
        result_str.add(s)
